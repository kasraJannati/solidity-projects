...
contract Bet is VRFConsumerBaseV2{
    ...
    uint16 requestConfirmations = 3; //How many confirmations the Chainlink node should wait before responding. The longer the node waits, the more secure the random value is. It must be greater than the minimumRequestBlockConfirmations limit on the coordinator contract.
    ...
    address mainWallet = 0xEd79eA59df5d665802A13d9589675c52057a9A65;
    uint costTicket = 0.000001 ether;
    address owner;
    ...
    function requestRandomWords() external onlyOwner {   //  Takes your specified parameters and submits the request to the VRF coordinator contract.
    ...
    function fulfillRandomWords( //Receives random values and stores them with your contract.
        uint256, /* requestId */
